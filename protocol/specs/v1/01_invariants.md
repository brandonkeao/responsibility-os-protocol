...
1. **Alignment Loop** – Every task proposal references either an active Mandate run or an accepted RequestForAction plus the Guardrails clause that authorizes it; the Kernel refuses execution if any link is missing.
